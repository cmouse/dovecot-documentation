...
(`RFC5435 <http://tools.ietf.org/html/rfc5435/>`__) adds notify action to the Sieve language.
...
:ref:`plugin-sieve-setting-sieve_notify_mailto_envelope_from setting`
   ...
   This is similar to :ref:`plugin-sieve-setting-sieve_redirect_envelope_from` setting for redirect.
...
Send notification is we receive mail from domain
------------------------------------------------
